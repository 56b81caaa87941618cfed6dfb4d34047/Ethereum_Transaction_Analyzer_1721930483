...
Vue.component("purple_feature_grid_component_1721930484", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our cutting-edge Ethereum transaction analysis. Monitor new transactions as they happen, giving you a competitive edge in the ever-evolving blockchain landscape.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Gain valuable insights into Ethereum transaction data with our powerful analytics engine. Uncover patterns, identify trends, and make informed decisions based on comprehensive data analysis.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Never miss a beat with our customizable alert system. Set up personalized notifications for specific transaction types, amounts, or addresses, ensuring you're always in the know.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Our platform prioritizes security and reliability, employing industry-leading practices to safeguard your data and ensure uninterrupted access to transaction analysis capabilities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">User-Friendly Interface</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Navigate our intuitive interface with ease, allowing you to quickly access the information you need and make informed decisions without unnecessary complexity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Scalable and Future-Proof</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Our solution is designed to grow with the ever-expanding Ethereum network, ensuring you have the tools to stay ahead of the curve as the ecosystem evolves.</p></div>
        </div>
    </div>`,
        data() {
            return {
